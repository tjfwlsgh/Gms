...
/**
 * @FileName    : InfFacilityMgmtResponse.java
 * @Date        : 22.02.21
 * @Author      : hj.Chung
 ...
 */
@Data
public class InfFacilityMgmtResponse {
...
//	private String rntNm;		// 임대 명
	...
	private BigDecimal qty;		// 수량 => 면적(m2)
...
//	private String ltcYn;		// 장기계약 YN
	...
	private String contPrd;		// 계약 기간
	
	private String pnltyNote;	// 위약금 비고
	private String crncyCd;		// 통화코드
	private BigDecimal hre;		// 임차료 => 임차료(월)
	...
	private String locClNm;		// 위치 구분명 => 구분
	private String rntClNm;		// 임대 구분명 => 소유
	...
	private BigDecimal untar;	// 면적 (평)
	
	
	public InfFacilityMgmtResponse() {}
