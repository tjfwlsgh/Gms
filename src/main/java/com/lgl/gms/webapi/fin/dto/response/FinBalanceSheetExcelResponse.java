 ...
 */
@Data
public class FinBalanceSheetExcelResponse {
     ...
     * @return
     */
    public static FinBalanceSheetExcelResponse from(Row row) {
    	
    	return ExcelUtil.setObjectMapping(new FinBalanceSheetExcelResponse(), row);
    }    
